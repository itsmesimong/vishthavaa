                ...
                <div className="tp-footer-widget footer-col-4 mb-50">
                  ...
                  <div className="tp-footer-widget-content">
                    <div className="tp-footer-talk mb-20">
                      ...
                      <h4><a href="tel:670-413-90-762">+91 9422 035 008</a></h4>
                    </div>
                    <div className="tp-footer-contact">
                      ...
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="https://www.google.com/maps/" target="_blank">1 New Street.
 <br /> Nungambakkam Main Road, Nungambakkam 600034</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="row align-items-center">
                <div className="col-md-6">
                  <div className="tp-footer-copyright">
                    <p>© {new Date().getFullYear()} All Rights Reserved  |  Developed By VMW
                      <Link href="/">{" "}❤</Link>.
                    </p>
                  </div>
                </div>
